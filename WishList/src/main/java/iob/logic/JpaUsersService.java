...
public class JpaUsersService implements UsersService {
	...
	public UserBoundary login(String userDomain, String userEmail) {
		Optional<UserEntity> userEntityOp = this.userDao.findById(userDomain + "@@" + userEmail);
	...
	public UserBoundary updateUser(String userDomain, String userEmail, UserBoundary update) {
		...
		if ((userDomain != null && !userDomain.contentEquals(update.getUserId().getDomain()))
				|| (userEmail != null && !userEmail.contentEquals(update.getUserId().getEmail()))) 
	...
	public UserEntity UserBoundaryToEntity(UserBoundary boundary) throws RuntimeException {
	...
	public UserBoundary UserEntityToBoundary(UserEntity entity) throws RuntimeException {
		UserBoundary userBoundary = new UserBoundary();
		String domain = entity.getUserId().split("@@")[0];
		String email = entity.getUserId().split("@@")[1];
		userBoundary.setUserId(new UserId(email, domain));
	 ...
	 */
	public void checkVaildBoundary(UserBoundary userBoundary) throws RuntimeException {
